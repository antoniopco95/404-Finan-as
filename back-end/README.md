...
**Repositório de Backend**: https://github.com/antoniopco95/back-equipe-09

**Repositório de Frontend**: https://github.com/antoniopco95/front-equipe-09

**URL da aplicação funcionando**: https://front-equipe-09-git-main-antoniopco95.vercel.app/

---

E os itens abaixo, que deverão ser preenchidos apenas após a finalização de todas as sprints do projeto:

**Pull Request (PR) de Backend**: https://github.com/cubos-academy/back-integral-m05-t11/pull/5

**Pull Request (PR) de Frontend**: https://github.com/cubos-academy/front-integral-m05-t11/pull/5
